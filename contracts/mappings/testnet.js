...
const mapping = {
    // Tokens
    [tokens.DAI]: [
        { version: 1, address: testnetAddresses.SAI, abi: abiMap.general.erc20, decimals: 18 },
    ],
    [tokens.WETH]: [
        { version: 1, address: testnetAddresses.GEM, abi: abiMap.dappHub.dsEthToken, decimals: 18 },
    ],
    [tokens.PETH]: [
        { version: 1, address: testnetAddresses.SKR, abi: abiMap.general.erc20, decimals: 18 },
    ],
    [tokens.MKR]: [
        { version: 1, address: '0x0000000000000000000000000000000000000001', abi: abiMap.general.erc20, decimals: 18 },
        { version: 2, address: testnetAddresses.GOV, abi: abiMap.general.erc20, decimals: 18 },
    ],
    ...
    // Exchanges
    [contracts.MAKER_OTC]: [
        { version: 1, address: testnetAddresses.MAKER_OTC, abi: abiMap.exchangesV1.makerOtc }
    ]
};
