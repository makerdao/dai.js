...
const mapping = {
    // Tokens
    [tokens.DAI]: [
        { version: 1, address: kovanAddresses.SAI, abi: abiMap.general.erc20, decimals: 18 }
    ],
    [tokens.WETH]: [
        { version: 1, address: kovanAddresses.GEM, abi: abiMap.dappHub.dsEthToken, decimals: 18 }
    ],
    [tokens.PETH]: [
    ...
    // Exchanges
    [contracts.MAKER_OTC]: [
        { version: 1, address: kovanAddresses.MAKER_OTC, abi: abiMap.exchangesV1.makerOtc }
    ],
    [contracts.ZERO_EX_EXCHANGE]: [
        { version: 1, address: kovanAddresses.ZERO_EX_EXCHANGE, abi: abiMap.exchangesV1.zeroExExchange }
    ]
};
