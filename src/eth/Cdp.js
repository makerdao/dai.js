...
export default class Cdp {
  ...
  getCollateralValueInEth() {
    return this.getId().then(id => this._cdpService.getCdpCollateralInEth(id));
  }

  getCollateralValueInUSD() {
    return this.getId().then(id => this._cdpService.getCdpCollateralInUSD(id));
  }

  getDebtValueInDai() {
    return this.getId().then(id => this._cdpService.getCdpDebtInDai(id));
  }

  getDebtValueInUSD() {
    return this.getId().then(id => this._cdpService.getCdpDebtInUSD(id));
  }
