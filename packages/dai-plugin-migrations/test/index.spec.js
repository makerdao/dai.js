...
test('contract address mapping', async () => {
  const address = maker
    ...
    .getContractAddressByName('MULTICALL');
  expect(address).toEqual(addresses.MULTICALL);
});

xtest('contract address overrides', async () => {
...
xtest('COL1 token basic functionality', async () => {
