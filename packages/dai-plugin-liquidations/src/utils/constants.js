...
export const MCD_CLIP_CALC_UNIV2DAIETH_A = 'MCD_CLIP_CALC_UNIV2DAIETH_A';
export const MCD_CLIP_UNIV2USDCETH_A = 'MCD_CLIP_UNIV2USDCETH_A';
export const MCD_CLIP_CALC_UNIV2USDCETH_A = 'MCD_CLIP_CALC_UNIV2USDCETH_A';
export const MCD_CLIP_UNIV2ETHUSDT_A = 'MCD_CLIP_UNIV2ETHUSDT_A';
export const MCD_CLIP_CALC_UNIV2ETHUSDT_A = 'MCD_CLIP_CALC_UNIV2ETHUSDT_A';
export const MCD_CLIP_UNIV2WBTCDAI_A = 'MCD_CLIP_UNIV2WBTCDAI_A';
export const MCD_CLIP_CALC_UNIV2WBTCDAI_A = 'MCD_CLIP_CALC_UNIV2WBTCDAI_A';
export const MCD_CLIP_UNIV2WBTCETH_A = 'MCD_CLIP_UNIV2WBTCETH_A';
export const MCD_CLIP_CALC_UNIV2WBTCETH_A = 'MCD_CLIP_CALC_UNIV2WBTCETH_A';
export const MCD_CLIP_UNIV2LINKETH_A = 'MCD_CLIP_UNIV2LINKETH_A';
export const MCD_CLIP_CALC_UNIV2LINKETH_A = 'MCD_CLIP_CALC_UNIV2LINKETH_A';
export const MCD_CLIP_UNIV2UNIETH_A = 'MCD_CLIP_UNIV2UNIETH_A';
export const MCD_CLIP_CALC_UNIV2UNIETH_A = 'MCD_CLIP_CALC_UNIV2UNIETH_A';
export const MCD_CLIP_UNIV2AAVEETH_A = 'MCD_CLIP_UNIV2AAVEETH_A';
export const MCD_CLIP_CALC_UNIV2AAVEETH_A = 'MCD_CLIP_CALC_UNIV2AAVEETH_A';
export const MCD_CLIP_UNIV2DAIUSDT_A = 'MCD_CLIP_UNIV2DAIUSDT_A';
export const MCD_CLIP_CALC_UNIV2DAIUSDT_A = 'MCD_CLIP_CALC_UNIV2DAIUSDT_A';
