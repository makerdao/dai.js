  ...
  async getEventHistory() {
    ...
    return Promise.all(
      events.map(async e => {
        ...
        returnObj.changeInCollateral = this.currency.wei(Math.abs(e.dink));
        ...
        returnObj.resultingCollateral = this.currency.wei(e.urn.nodes[0].ink);
