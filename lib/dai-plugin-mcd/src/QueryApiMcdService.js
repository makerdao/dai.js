...
export default class QueryApi extends PublicService {
  ...
  async getCdpEventsAllIlks(urn) {
    ...
    const [r1, r2] = await Promise.all([
      this.getCdpEvents(urn, ilks[1]),
      this.getCdpEvents(
        'cba1bbad5fe83cf0bc96028ae3ed8bb98b56986d0000000000000000000000c1',
        ilks[1]
      )
    ]);
    console.log('r1', r1);
    console.log('r2', r2);
    const arr = [];
    const arrConcat = arr.concat(r1, r2);
    const arrSort = arrConcat.sort(function(a, b) {
