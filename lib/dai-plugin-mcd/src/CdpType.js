...
export default class CdpType {
  ...
  // should these auction-related data be moved to an auction object?

  //returns time in hours
  async getMaxBidLifetime() {
    const flipContract = this._flipContract();
  ...
  _pipContract() {
    return this._smartContract.getContract(getPipContractNameForCurrency(this._currency));
  }

  _flipContract() {
    return this._smartContract.getContract(getFlipContractNameForCurrency(this._currency));
  }

  _spotContract() {
    return this._smartContract.getContract(getSpotContractNameForCurrency(this._currency));
  }
