...
export default class SystemDataService extends PublicService {
  ...
  async getAnnualBaseRate() {
    ...
    // this change for v0.2.9 will need to be reverted
    // on the next version (removed .plus(1) from the following
    // line)
    const baseBigNumber = new BigNumber(base.toString()).dividedBy(RAY);
