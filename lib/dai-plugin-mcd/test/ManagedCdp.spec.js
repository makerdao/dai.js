...
describe.each([
  ...
  test('getEventHistory', async () => {
    const dummyData = [{ 
      dart: '-6000000000000000000', //todo try making this negative, and changing draw to wipe
      dink: '0',
      ...
      urn: { nodes: [ { art: '6849191748702380000', ink: '5336190215977040000' } ] }
    }];

    const formattedDummyData = [{
      transactionHash: '0xbe023a205453b833e65bf29063de8b8b3bd44d2e68c9c079f681ec46a765a63f',
    ...
    expect(events).toEqual(formattedDummyData);
  });
