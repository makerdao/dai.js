...
describe.each([
  ...
  test('openLockAndDraw, get, draw, wipe, wipeAndFree', async () => {
    ...
    const [ collateralValue, collateralizationRatio, safe, minCollateral, availCollateral, daiAvailable ] = await Promise.all([
    ...
    // const collateralizationRatio = await
    // const safe = await ;
    // const minCollateral = await ;
    // const availCollateral = await ;
    // const daiAvailable = await ;

    console.log(collateralValue, collateralizationRatio, safe, minCollateral, availCollateral, daiAvailable)
